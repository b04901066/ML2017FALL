...
print(model.summary())
model.fit(X_train, y_train, batch_size=batch_, epochs=20, validation_split=0.1, callbacks=[ EarlyStopping( monitor='val_acc', patience=3), ModelCheckpoint( filepath=sys.argv[2], verbose=1, save_best_only=True)])
